...
const AddRestaurantForm = ({refresh}) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
        ...
        <input name="image" defaultValue="https://coding-platform.s3.amazonaws.com/dev/lms/tickets/7524df6e-46fa-4506-8766-eca8da47c2f1/2izhqnTaNLdenHYF.jpeg" alt="image" />
